...
S3_WIKI_BUCKET = "ceu-zhengying-wikidata" 
...
JSON_LOCATION_DIR = Path("./my_directory") 

JSON_LOCATION_DIR.mkdir(parents=True, exist_ok=True)
...
print(f"File saved to: {json_lines_file}")
